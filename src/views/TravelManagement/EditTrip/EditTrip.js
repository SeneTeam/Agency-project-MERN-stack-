...
const EditTrip = props => {
  ...
  useEffect(() => {
    getSingleTrip(match.params.id).then(({ data }) => {
  ...
  const handleFormSubmit = e => {
    ...
    updateTrip(match.params.id, formData)
      .then(res => {
        setLoading(false);
  ...
  const handleDeleteBanner = img => {
    deleteBannerImage(match.params.id, img).then(res => console.log(res));
  };
  const handleDeleteGallery = img => {
    deleteGalleryImage(match.params.id, img).then(res => console.log(res));
  };
  return (
                    ...
                    <Grid container spacing={3} style={{ margin: '0px 30px' }}>
                      ...
                      <Grid item md={2} xs={12}>
                        <FormControl fullWidth variant="outlined">
                          ...
                          <OutlinedInput
                            value={values.interior.adultPrice}
                      ...
                      <Grid item md={2} xs={12}>
                        <FormControl fullWidth variant="outlined">
                          ...
                          <OutlinedInput
                            value={values.interior.childPrice}
                      ...
                      <Grid item md={2} xs={12}>
                        <FormControl fullWidth variant="outlined">
                          <InputLabel>Adult Price</InputLabel>
                          <OutlinedInput
                            value={values.exterior.adultPrice}
                      ...
                      <Grid item md={2} xs={12}>
                        <FormControl fullWidth variant="outlined">
                          <InputLabel>Child Price</InputLabel>
                          <OutlinedInput
                            value={values.exterior.childPrice}
                      ...
                      <Grid item md={2} xs={12}>
                        <FormControl fullWidth variant="outlined">
                          <InputLabel>Adult Price</InputLabel>
                          <OutlinedInput
                            value={values.balcony.adultPrice}
                      ...
                      <Grid item md={2} xs={12}>
                        <FormControl fullWidth variant="outlined">
                          <InputLabel>Child Price</InputLabel>
                          <OutlinedInput
                            value={values.balcony.childPrice}
